  ...
  return {
    fields: [
      ...
      },
      {
        ...
        hint: "When selected, Paperclip uses the isolated local CLI lane; explicit ACP fails closed and auto selects CLI. API keys, custom routing, and unverifiable authentication are rejected before execution.",
      },
      {
        key: "agentCommand",
