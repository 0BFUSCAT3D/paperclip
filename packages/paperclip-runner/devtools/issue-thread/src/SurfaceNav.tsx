import type { Phase7Surface } from "./route";

/**
 * Top-level surface switch (Phase 7 plan revision 5).
 *
 * Phase 7 now has two primary paths, not one path with a mode toggle: the
 ...
 */
export function SurfaceNav({ surface }: { surface: Phase7Surface }) {
  return (
    <nav className="pit-surface-nav" aria-label="Phase 7 surfaces" data-testid="surface-nav">
      <a
