...
export function ContextPanel({
  ...
  artifact: Phase7RunArtifact | null;
}) {
  return (
...
export function ExposureList({ exposure }: { exposure: Phase7Exposure }) {
  return (
    <>
...
export function denialCount(records: readonly Phase7AuthorizationRecord[]): number {
...
export function StateDiffPanel({ diff }: { diff: Phase7StateDiff | null }) {
  if (diff === null) {
    return (
...
export function ParityPanel({ parity }: { parity: Phase7ParityReport | null }) {
  if (parity === null) {
    return (
  ...
  return (
    <div className="pcr7-panel" data-testid="panel-parity">
      ...
      <h4 className="pcr7-label">Phase 7E conformance suite</h4>
      <p data-testid="parity-eval-suite">
        ...
        {parity.evalSuite.available ? (
          ...
          <span className="pcr7-muted">
            no Phase 7E report is loaded; this explorer renders 7E output and never recomputes it.
          </span>
        )}
      </p>
