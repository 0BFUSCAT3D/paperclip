...
export const DISPOSITION_LABEL: Record<Phase7PrimaryDisposition, string> = {
  control_plane_owned: "Control plane",
  always_agent_tool: "Always tool",
  optional_agent_tool: "Optional tool",
};

export const DISPOSITION_TONE: Record<Phase7PrimaryDisposition, "neutral" | "accent" | "success"> = {
  control_plane_owned: "neutral",
  always_agent_tool: "success",
  optional_agent_tool: "accent",
};

export const ASSERTION_CLASS_LABEL: Record<Phase7AssertionClass, string> = {
...
export const PARITY_LABEL: Record<Phase7ParityStatus, string> = {
  pass: "Pass",
  fail: "Fail",
...
export const PARITY_ICON: Record<Phase7ParityStatus, string> = {
  pass: "✓",
  fail: "✕",
  intentional_gap: "◑",
  not_run: "○",
...
export const PARITY_TONE: Record<Phase7ParityStatus, "success" | "danger" | "warning" | "neutral"> = {
  pass: "success",
  fail: "danger",
...
export const CHANGE_LABEL: Record<Phase7DiffChangeKind, string> = {
  added: "Added",
  changed: "Changed",
  removed: "Removed",
};

export const CHANGE_ICON: Record<Phase7DiffChangeKind, string> = {
  added: "+",
  changed: "~",
  removed: "−",
};
