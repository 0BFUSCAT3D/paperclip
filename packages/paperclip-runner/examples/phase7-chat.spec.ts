 ...
 * its evidence, reset, and do it again on a phone. Screen captures for the §11
 * matrix are recorded by `scripts/record-phase7i-evidence.mjs`, which reuses
 * these routes.
 */
