...
/**
 * Parity judgement for one chat turn (Phase 7I).
 *
 ...
 * `phase7ScenarioParity` over the cumulative timeline.
 */
export function phase7TurnParity(input: Phase7ParityInput): Phase7ParityReport {
