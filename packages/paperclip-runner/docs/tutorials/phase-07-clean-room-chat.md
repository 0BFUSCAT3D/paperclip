# Phase 7 Tutorial: Chat With Real Codex In A Clean Room
...
This is the second primary Phase 7 path. The first — the preset scenario
explorer — is covered by the
[issue-thread tutorial](phase-07-issue-thread.md) and stays available and
unchanged. Read [the clean-room reference](../phase-07-clean-room-chat.md) for
...
```sh
pnpm --filter @paperclipai/paperclip-runner smoke:phase7:cleanroom -- --json
```
...
- [Clean-room chat reference](../phase-07-clean-room-chat.md) — seed, exposure
  profile, session routes, and bounds.
- [Execution modes and identity](../phase-07-execution-modes.md) — why a
  `mode=fake` artifact can never satisfy a live criterion.
- [Verification commands](../phase-07-verification-commands.md) — the full
