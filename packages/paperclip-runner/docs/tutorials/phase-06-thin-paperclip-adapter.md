...
This tutorial exercises the Phase 6 tracer entirely inside
...
Open `http://127.0.0.1:4182/phase6-standalone/`. The page starts on the legacy
...
pnpm --filter @paperclipai/paperclip-runner exec vitest run \
  src/standalone/phase6-demo.test.ts \
