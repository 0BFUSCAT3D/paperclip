# Phase 4b Protocol and Demo Server

## Scope

This is the lowest Phase 4b layer. It extends the package-local Codex driver,
...
`protocol/fixtures/phase-04b/driver-conformance.json` records the exact Codex
...
- `POST /api/phase4b/sessions`
- `GET /api/phase4b/sessions/:id`
- `GET /api/phase4b/sessions/:id/events?after=:cursor`
- `GET /api/phase4b/sessions/:id/stream?after=:cursor`
- `POST /api/phase4b/sessions/:id/steer`
- `POST /api/phase4b/sessions/:id/interrupt`
...
See the [verification record](../knowledge/evidence/2026-08-08-phase-04b-protocol-server-verification.md)
and [real server trace](../knowledge/evidence/phase-04b-real-codex-server.json).
