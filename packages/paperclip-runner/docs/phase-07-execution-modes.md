# Phase 7 execution modes and identity

Phase 7 runs the same semantic tool catalog, authorization engine, and mock
...
| Actor | What it is in Phase 7 | What it is **not** |
| --- | --- | --- |
...
See the [live runnerd and Codex loop](phase-07-live-runnerd-codex.md) reference
for the session API, and the
[final evidence manifest](../knowledge/evidence/2026-08-10-phase-07i-final-evidence.md)
for the command-by-command record behind each row above.
