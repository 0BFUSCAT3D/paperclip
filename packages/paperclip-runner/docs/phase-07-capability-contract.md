<!-- GENERATED FILE — DO NOT EDIT. Run pnpm generate:phase7-inventory. -->

# Phase 7A Capability Contract
...
- `pnpm --dir packages/paperclip-runner generate:phase7-inventory` imports the canonical baselines and rewrites every generated file.
- `pnpm --dir packages/paperclip-runner check:phase7-inventory` validates counts, uniqueness, normative dispositions, one-to-one MCP folds, required fields, and generated-file drift without requiring the external eval repository.
...
| skill:skills/paperclip/SKILL.md:the-heartbeat-procedure:28 | optional_agent_tool | skills/paperclip/SKILL.md:28 |
| skill:skills/paperclip/SKILL.md:generated-artifacts-and-work-products:99 | always_agent_tool | skills/paperclip/SKILL.md:99 |
| skill:skills/paperclip/SKILL.md:status-quick-guide:144 | control_plane_owned | skills/paperclip/SKILL.md:144 |
| skill:skills/paperclip/SKILL.md:monitors-and-watchers-say-only-what-you-actually-scheduled:154 | optional_agent_tool | skills/paperclip/SKILL.md:154 |
| skill:skills/paperclip/SKILL.md:delegating-review-tasks:167 | always_agent_tool | skills/paperclip/SKILL.md:167 |
| skill:skills/paperclip/SKILL.md:managing-a-user-s-inbox:178 | control_plane_owned | skills/paperclip/SKILL.md:178 |
| skill:skills/paperclip/SKILL.md:issue-dependencies-blockers:186 | control_plane_owned | skills/paperclip/SKILL.md:186 |
| skill:skills/paperclip/SKILL.md:requesting-board-approval:211 | optional_agent_tool | skills/paperclip/SKILL.md:211 |
| skill:skills/paperclip/SKILL.md:issue-thread-interactions:232 | optional_agent_tool | skills/paperclip/SKILL.md:232 |
| skill:skills/paperclip/SKILL.md:standalone-decisions:258 | optional_agent_tool | skills/paperclip/SKILL.md:258 |
| skill:skills/paperclip/SKILL.md:mcp-tool-approval-gates:362 | optional_agent_tool | skills/paperclip/SKILL.md:362 |
| skill:skills/paperclip/SKILL.md:niche-workflow-pointers:404 | optional_agent_tool | skills/paperclip/SKILL.md:404 |
| skill:skills/paperclip/SKILL.md:cases:414 | optional_agent_tool | skills/paperclip/SKILL.md:414 |
| skill:skills/paperclip/SKILL.md:company-skills-workflow:419 | optional_agent_tool | skills/paperclip/SKILL.md:419 |
| skill:skills/paperclip/SKILL.md:routines:430 | optional_agent_tool | skills/paperclip/SKILL.md:430 |
| skill:skills/paperclip/SKILL.md:issue-workspace-runtime-controls:441 | optional_agent_tool | skills/paperclip/SKILL.md:441 |
| skill:skills/paperclip/SKILL.md:proposing-credentials-safely:448 | optional_agent_tool | skills/paperclip/SKILL.md:448 |
| skill:skills/paperclip/SKILL.md:reading-granted-secrets:455 | optional_agent_tool | skills/paperclip/SKILL.md:455 |
| skill:skills/paperclip/SKILL.md:critical-rules:481 | optional_agent_tool | skills/paperclip/SKILL.md:481 |
| skill:skills/paperclip/SKILL.md:comment-style-required:505 | always_agent_tool | skills/paperclip/SKILL.md:505 |
| skill:skills/paperclip/SKILL.md:update:537 | optional_agent_tool | skills/paperclip/SKILL.md:537 |
| skill:skills/paperclip/SKILL.md:planning-required-when-planning-requested:547 | optional_agent_tool | skills/paperclip/SKILL.md:547 |
| skill:skills/paperclip/SKILL.md:key-endpoints-hot-routes:580 | optional_agent_tool | skills/paperclip/SKILL.md:580 |
| skill:skills/paperclip/SKILL.md:searching-issues:609 | optional_agent_tool | skills/paperclip/SKILL.md:609 |
| skill:skills/paperclip/SKILL.md:full-reference:619 | optional_agent_tool | skills/paperclip/SKILL.md:619 |
...
| skill:skills/paperclip/references/api-reference.md:checkbox-confirmations:923 | always_agent_tool | skills/paperclip/references/api-reference.md:923 |
| skill:skills/paperclip/references/api-reference.md:item-verdict-requests:1038 | optional_agent_tool | skills/paperclip/references/api-reference.md:1038 |
| skill:skills/paperclip/references/api-reference.md:checking-approval-status:1148 | optional_agent_tool | skills/paperclip/references/api-reference.md:1148 |
| skill:skills/paperclip/references/api-reference.md:approval-follow-up-requesting-agent:1154 | always_agent_tool | skills/paperclip/references/api-reference.md:1154 |
| skill:skills/paperclip/references/api-reference.md:issue-lifecycle:1172 | always_agent_tool | skills/paperclip/references/api-reference.md:1172 |
| skill:skills/paperclip/references/api-reference.md:error-handling:1202 | control_plane_owned | skills/paperclip/references/api-reference.md:1202 |
| skill:skills/paperclip/references/api-reference.md:full-api-reference:1216 | optional_agent_tool | skills/paperclip/references/api-reference.md:1216 |
| skill:skills/paperclip/references/api-reference.md:agents:1218 | optional_agent_tool | skills/paperclip/references/api-reference.md:1218 |
| skill:skills/paperclip/references/api-reference.md:issues-tasks:1239 | optional_agent_tool | skills/paperclip/references/api-reference.md:1239 |
| skill:skills/paperclip/references/api-reference.md:companies-projects-goals:1279 | optional_agent_tool | skills/paperclip/references/api-reference.md:1279 |
| skill:skills/paperclip/references/api-reference.md:routines:1303 | optional_agent_tool | skills/paperclip/references/api-reference.md:1303 |
| skill:skills/paperclip/references/api-reference.md:approvals-costs-activity-dashboard:1319 | optional_agent_tool | skills/paperclip/references/api-reference.md:1319 |
| skill:skills/paperclip/references/api-reference.md:secrets:1341 | optional_agent_tool | skills/paperclip/references/api-reference.md:1341 |
| skill:skills/paperclip/references/api-reference.md:agent-secret-proposals:1354 | optional_agent_tool | skills/paperclip/references/api-reference.md:1354 |
| skill:skills/paperclip/references/api-reference.md:agent-secret-access:1413 | optional_agent_tool | skills/paperclip/references/api-reference.md:1413 |
| skill:skills/paperclip/references/api-reference.md:common-mistakes:1452 | optional_agent_tool | skills/paperclip/references/api-reference.md:1452 |
