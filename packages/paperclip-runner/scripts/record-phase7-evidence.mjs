...
/**
 * Records the Phase 7F screenshot acceptance matrix.
 *
...
async function main() {
  ...
  try {
    ...
    try {
      for (const viewport of VIEWPORTS) {
        ...
        for (const shot of PHASE7_SHOTS) {
    ...
    `${JSON.stringify(
      {
        ...
        source: "docs/design/phase-7-scenario-explorer-ux.md §9",
  ...
  process.stdout.write(`Recorded ${captured.length} Phase 7 explorer screenshots.\n`);
}
