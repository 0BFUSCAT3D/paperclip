...
The retained evidence is limited to current, machine-readable conformance
records that remain useful to package verification and debugging.

- [Durable recovery fault matrix](durable-recovery-fault-matrix.json)
- [Durable recovery trace](durable-recovery-trace.json)
