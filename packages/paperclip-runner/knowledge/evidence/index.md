...
* [Phase 7Q live turn streaming verification](2026-08-10-phase-07q-turn-streaming-verification.md) - Live turn events, the NDJSON turn stream, incremental browser rendering on one growing assistant card, stop and abandonment behaviour, the preserved security properties, and a measured real Codex turn.
* [Phase 7U streamed-evidence disclosure and session capability verification](2026-08-10-phase-07u-disclosure-and-capability-verification.md) - Allowlisted public stream DTO, redaction applied before evidence persistence, per-browser session capability binding with rotation, the canary and two-cookie-jar regression sets observed failing against the rejected behaviour, and the byte-accurate stream frame cap.
