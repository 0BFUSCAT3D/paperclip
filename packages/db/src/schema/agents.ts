...
export const agents = pgTable(
  "agents",
  {
    ...
    executionProfileRevision: bigint("execution_profile_revision", { mode: "number" }).notNull().default(1),
  ...
  (table) => ({
    scopedIdentityUq: uniqueIndex("agents_scoped_identity_uq").on(table.id, table.companyId),
