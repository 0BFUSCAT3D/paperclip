...
function isTaskWatchdogSelfWakeUniqueConflict(error: unknown) {
  return isUniqueConstraintConflict(error, "agent_wakeup_requests_task_watchdog_self_idempotency_uq");
}
